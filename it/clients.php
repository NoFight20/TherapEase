...
if (isset($_SESSION["user"])) {
    if ($_SESSION["user"] == "" || $_SESSION['usertype'] != 'i') {
...
// Perform the query to get the patients' accounts
$result = $database->query("SELECT pemail, ppassword FROM patient ORDER BY pid");
...
while ($row = $result->fetch_assoc()) {
    ...
    $password = htmlspecialchars($row['ppassword']);
    $patientsAccountRows .= "<tr>
        <td>$email</td>
        <td>$password</td>
    </tr>";
}
		...
		<div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Clients</p>
